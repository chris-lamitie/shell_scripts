#!/bin/bash
#
# "git_configure.sh" found on miguelgfierro's github repo: https://github.com/miguelgfierro/scripts/blob/main/git_configure.sh
# retrieved 2023-07-05. Untested, but I like the aliases and checking/setting up ssh keys. Those are good ideas.
#
