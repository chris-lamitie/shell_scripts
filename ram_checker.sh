...
top_output=$(top -bn1 -o %MEM | head -n 20) # Sorts top by %Mem
...
echo ""
echo -e "Top stats:\n$spacer"
echo -e "Load Average: $top_load_average"
#echo -e "Top Mem Stats:\n$top_memory_stats"
echo -e "Process Stats:\n$top_process_stats"
